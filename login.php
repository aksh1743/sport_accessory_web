<?php
    ...
    $fail_login_password_info=0;
    $fail_login_username_info=0;
    if(isset($_POST['submit']))
    {
        ...
        if($u_n_q == True)
        {
            ...
            {
                $fail_login_password_info = 1;
            }
        }
        else{
            $fail_login_username_info = 1;
        }
...
<body>
        <form action = "login.php" method="post">
            <div class="login-form">
                    <h1>Get Started...</h1>
                    <?php
                        if($fail_login_password_info == 1){
                            echo "<h3 style='color:green; padding-left:15px;'>Password Incorrect.</h3>";                
                        }
                        if($fail_login_username_info == 1){
                            echo "<h3 style='color:red; padding-left:15px;'>user name Incorrect.</h3>";                
                        }
                    ?>
                    <div class="fields">
