...
<html lang="en">
<head>
    <title>Sport_sign_up_page</title>
    ...
    <form method="post" >
        <div class="sign-up-form">
            ...
            <?php
                ...
                if($fail_registration_info == 1){
                    echo "<h3 style='color:red; padding-left:15px;'>Registration failed.</h3>";                
                }
