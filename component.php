        ...
        <form method="post">
            <div class="card-shadow1">
                ...
                <div class="card-body pt-0 ml-0"> 
                    ...
                    <button type="submit" class="btn-md btn btn-warning mt-4" name="add_to_cart" style="border=2px;bottom:95%; solid #000;">Add to cart <i class="fa fa-cart-plus pl-2"></i></button>
